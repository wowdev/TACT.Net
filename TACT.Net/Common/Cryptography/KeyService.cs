...
namespace TACT.Net.Common.Cryptography
{
    public sealed class KeyService
    {
        ...
        private static Dictionary<ulong, byte[]> Keys = new Dictionary<ulong, byte[]>()
        {
            ...
            //{ 0xFAF9237E1186CF66, "????????????????????????????????".ToByteArray() }, // WOW-28048patch8.1.0_PTR   encrypted db2 sections (battle pet?)
            //{ 0x5DD92EE32BBF9ABD, "????????????????????????????????".ToByteArray() }, // WOW-27004patch8.0.1_Subm  filedataid 2238294
            //{ 0x0B68A7AF5F85F7EE, "????????????????????????????????".ToByteArray() }, // WOW-28151patch8.1.0_PTR   fdid 2459473, 2459583, 2459601, 2459618, 2459669, 2472143
            ...
            //{ 0x14C4257E557B49A1, "????????????????????????????????".ToByteArray() }, // WOW-28440patch8.1.0_PTR
            //{ 0x1254E65319C6EEFF, "????????????????????????????????".ToByteArray() }, // WOW-28440patch8.1.0_PTR
